    ...
    <div className="about">
      ...
      <section className="about-content">
        ...
        <div className="about-body">
          ...
          <p>
            Hi! I’m Azalea Tang, practice owner of Chee Somatics. I’m a first-born millennial daughter to first-generation Chinese immigrants, living most of my life in the Midwest. I grew up chronically overextending, people-pleasing, and being out of touch with my own needs until engaging with my own path of healing and transformation. Healing patterns of “striving” have allowed me to see the effects of racialized capitalism in others and help them find more balance and joy in life. 
          </p>
          <p>
            I come to this work as a somatic practitioner, connected to my ever-evolving identities of queerness, diaspora, and neurodivergence. I have 8+ years working as a social worker, spanning from community mental health to schools to private practice. In my work as a therapist, I am committed to individual and collective transformation by way of renegotiating past traumas and connecting with life force in real time. 
          </p>
          <p>
          ...
          <p>
            A lifelong student of healing and truth-seeking, I have received a bachelor’s degree in Religious Studies and a Master’s in Social Work. I am 200-hr level yoga teacher trained and a Somatic Experiencing Practitioner (SEP) with Somatic Healing International. 
          </p>
          ...
          <p>
            Somatic therapy involves intervention and exploration beyond cognitive “talk” therapy. I will likely invite you to explore other channels of experience, such as sensation, behavior, image, and movement. Many clients in this approach experience refreshing break-throughs in their lives, relationships, and capacity to be with what’s hard. 
          </p>
          ...
          <ul>
            ...
            <li> Identify with being a "helper" or work in a helping profession </li>
          </ul>
          <h2 className="section-heading">Specialties</h2>
          <ul>
            <li>AAPI, Queer, and marginalized identities</li>
            <li>Shock Trauma - Car Accidents, Sudden Loss, Sexual Trauma</li>
            ...
            <li>First/Second Generation Immigrant Issues, Diaspora</li>
            <li>LGBTQ+ Issues</li>
            <li>Polyamory</li>
